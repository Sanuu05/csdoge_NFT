                        ...
                        <div className="row">
                            ...
                            <div className="col-12 col-sm-6  res-margin">
                                ...
                                <div className="footer-items">
                                    ...
                                    {/* <li ><a href="/mycollection"><img src={md} style={{width:'50px',height:'50px',borderRadius:'6px',padding:'5px',boxShadow:'0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)'}} className="img-fluid"/> </a></li>
                                    <li ><a href="/csdoge"><img src={insta} style={{width:'50px',height:'50px',borderRadius:'6px',padding:'5px',boxShadow:'0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)'}} className="img-fluid"/> </a></li> */}
                                       
                                    </ul>
                                    <ul style={{display:'flex',justifyContent:'center'}}>
                                    {/* <li > <a href="/allnft"><img src={twitter} style={{width:'50px',height:'50px',borderRadius:'6px',padding:'5px',boxShadow:'0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)'}} className="img-fluid"/> </a></li>
                                    <li > <a href="/explore-1"><img src={telegram} style={{width:'50px',height:'50px',borderRadius:'6px',padding:'5px',boxShadow:'0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)'}} className="img-fluid"/> </a></li>
                                    <li ><a href="/create"><img src={email} style={{width:'50px',height:'50px',borderRadius:'6px',padding:'5px',boxShadow:'0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)'}} className="img-fluid"/> </a></li> */}
